...
<div className="docs">
    <div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
            ...
            <Paragraph>Il est organisé en monorepo avec trois packages principaux. Le package <code>@rte-ds/core</code> contient les design tokens et interfaces partagées, tandis que <code>@rte-ds/react</code> fournit les composants **React** spécifiques. Cette architecture permet une maintenance centralisée tout en offrant des implémentations optimisées pour chaque framework.</Paragraph>
        </div>
    </div>
    ...
    <Body>
        ...
        <Accordion title="Installation" id="installation">
            <div style={{ display: "flex", flexDirection: "column", gap: "24px", padding: "4px 8px" }}>
                ...
                ```bash
                npm install @rte-ds/react
                ```

                <Paragraph>Le package <code>@rte-ds/core</code> sera automatiquement installé comme dépendance pour accéder directement aux design tokens et interfaces **TypeScript**.</Paragraph>
        ...
        <Accordion title="Configuration initiale" id="setup-configuration">
            <div style={{ display: "flex", flexDirection: "column", gap: "24px", padding: "4px 8px" }}>
                ...
                <DocsSection title="Ajouter le mixin Branding/Theme" headingLevel={3}>
                    ...
                    <Paragraph className="light-gray">(Si vous n'avez pas de support scss, vous pouvez utiliser les fichiers .css dans <code>@rte-ds/core/css/rte-themes.css</code> et les ajouter à votre fichier principal (<code>main.tsx</code> ou <code>index.tsx</code>)).</Paragraph>
