import { REQUIREMENT_INDICATOR_VALUE } from "../../core-types/required-indicator/required-indicator.constant";
import { RequiredIndicatorProps } from "../../core-types/required-indicator/required-indicator.interface";
